...
#line 11 "fatfs\\diskio.c"

#line 1 "D:\\program files (x86)\\keil5\\ARM\\ARMCC\\Bin\\..\\include\\time.h"
...
#line 41 "D:\\program files (x86)\\keil5\\ARM\\ARMCC\\Bin\\..\\include\\time.h"
    ...
    typedef unsigned int size_t;    
#line 57 "D:\\program files (x86)\\keil5\\ARM\\ARMCC\\Bin\\..\\include\\time.h"
...
#line 73 "D:\\program files (x86)\\keil5\\ARM\\ARMCC\\Bin\\..\\include\\time.h"
...
#line 280 "D:\\program files (x86)\\keil5\\ARM\\ARMCC\\Bin\\..\\include\\time.h"



 

#line 13 "fatfs\\diskio.c"
...
)
{
	...
	if(count==1)
    {
		res = SD_ReadBlock(buff,sector << 9  ,512U);        
	}
	else
    {
		res =  SD_ReadMultiBlocks(buff,sector << 9 ,512U,count);        
	} 
...
)
{
    ...
    {    
		...
		if(count==1)
		{          
				res = SD_WriteBlock((u8 *)buff,sector << 9 ,512U);
		}
		else
		{          
				res = SD_WriteMultiBlocks((u8 *)buff,sector <<9 ,512U,count);
		}
