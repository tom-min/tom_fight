#line 1 "Utilities\\STM32_EVAL\\Common\\stm32_eval_sdio_sd.c"
...
#line 1 "Utilities\\STM32_EVAL\\Common\\stm32_eval_sdio_sd.h"
...
#line 145 ".\\Utilities\\STM32_EVAL\\stm32_eval.h"
...
#line 154 ".\\Utilities\\STM32_EVAL\\stm32_eval.h"
...
#line 347 ".\\Utilities\\STM32_EVAL\\stm32_eval.h"
...
#line 100 ".\\Utilities\\STM32_EVAL\\stm3210e_eval/stm3210e_eval.h"


 
#line 110 ".\\Utilities\\STM32_EVAL\\stm3210e_eval/stm3210e_eval.h"


 
#line 120 ".\\Utilities\\STM32_EVAL\\stm3210e_eval/stm3210e_eval.h"


 
#line 130 ".\\Utilities\\STM32_EVAL\\stm3210e_eval/stm3210e_eval.h"


     
#line 140 ".\\Utilities\\STM32_EVAL\\stm3210e_eval/stm3210e_eval.h"


 
#line 150 ".\\Utilities\\STM32_EVAL\\stm3210e_eval/stm3210e_eval.h"


    
#line 160 ".\\Utilities\\STM32_EVAL\\stm3210e_eval/stm3210e_eval.h"


   
#line 170 ".\\Utilities\\STM32_EVAL\\stm3210e_eval/stm3210e_eval.h"
...
#line 191 ".\\Utilities\\STM32_EVAL\\stm3210e_eval/stm3210e_eval.h"



  
#line 204 ".\\Utilities\\STM32_EVAL\\stm3210e_eval/stm3210e_eval.h"
...
#line 254 ".\\Utilities\\STM32_EVAL\\stm3210e_eval/stm3210e_eval.h"
...
#line 277 ".\\Utilities\\STM32_EVAL\\stm3210e_eval/stm3210e_eval.h"
...
#line 155 ".\\Utilities\\STM32_EVAL\\stm32_eval.h"
#line 164 ".\\Utilities\\STM32_EVAL\\stm32_eval.h"




  
#line 182 ".\\Utilities\\STM32_EVAL\\stm32_eval.h"



  
#line 322 ".\\Utilities\\STM32_EVAL\\stm32_eval.h"
...
#line 32 "Utilities\\STM32_EVAL\\Common\\stm32_eval_sdio_sd.h"
...
#line 252 "Utilities\\STM32_EVAL\\Common\\stm32_eval_sdio_sd.h"




#line 263 "Utilities\\STM32_EVAL\\Common\\stm32_eval_sdio_sd.h"




 
#line 276 "Utilities\\STM32_EVAL\\Common\\stm32_eval_sdio_sd.h"




 
#line 292 "Utilities\\STM32_EVAL\\Common\\stm32_eval_sdio_sd.h"
...
#line 314 "Utilities\\STM32_EVAL\\Common\\stm32_eval_sdio_sd.h"
...
#line 48 "Utilities\\STM32_EVAL\\Common\\stm32_eval_sdio_sd.c"
...
#line 107 "Utilities\\STM32_EVAL\\Common\\stm32_eval_sdio_sd.c"
...
#line 133 "Utilities\\STM32_EVAL\\Common\\stm32_eval_sdio_sd.c"
...
SD_Error SD_Init(void)
{
  ...
  if (errorstatus == SD_OK)
  {  
    errorstatus = SD_SetDeviceMode(((uint32_t)0x00000000));
  }
...
uint8_t SD_Detect(void)
{
  ...
  if (GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), ((uint16_t)0x0800)) != Bit_RESET)
  {
    status = ((uint8_t)0x00);
  }
  return status;
...
SD_Error SD_ReadMultiBlocks(uint8_t *readbuff, uint32_t ReadAddr, uint16_t BlockSize, uint32_t NumberOfBlocks)
{
  ...
  if (NumberOfBlocks > 1)
  {
    ...
    if (NumberOfBlocks * BlockSize > ((uint32_t)0x01FFFFFF))
    {
      errorstatus = SD_INVALID_PARAMETER;
      return(errorstatus);
    }
    ...
    if (DeviceMode == ((uint32_t)0x00000002))
    {
      ...
      if (SDIO_GetFlagStatus(((uint32_t)0x00000100)) != RESET)
      {
        ...
        if ((((uint32_t)0x00000000) == CardType) || (((uint32_t)0x00000002) == CardType) || (((uint32_t)0x00000001) == CardType))
        {
  ...
  if (NumberOfBlocks > 1)
  {
    ...
    if (DeviceMode == ((uint32_t)0x00000002))
    {
      while (!(((SDIO_TypeDef *) (((uint32_t)0x40000000) + 0x18000))->STA & (((uint32_t)0x00000010) | ((uint32_t)0x00000002) | ((uint32_t)0x00000100) | ((uint32_t)0x00000008) | ((uint32_t)0x00000200))))
      {
        if (SDIO_GetFlagStatus(((uint32_t)0x00004000)) != RESET)
        {
          if (!((TotalNumberOfBytes - bytestransferred) < ((uint32_t)0x00000020)))
          {
            for (count = 0; count < ((uint32_t)0x00000008); count++)
            {
              SDIO_WriteData(*(tempbuff + count));
            ...
            tempbuff += ((uint32_t)0x00000008);
            bytestransferred += ((uint32_t)0x00000020);
          }
          else
          {
